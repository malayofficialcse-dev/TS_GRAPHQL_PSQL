        ...
        <section className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-lg shadow-slate-200/50">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-6">
              ...
              <p className="mt-2 text-slate-600">View users fetched from the backend API.</p>
            </div>
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-6">
              <h2 className="text-xl font-semibold">Products</h2>
              <p className="mt-2 text-slate-600">Browse product details and prices.</p>
            </div>
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-6">
              <h2 className="text-xl font-semibold">Categories</h2>
              <p className="mt-2 text-slate-600">Browse category names managed by the backend.</p>
            </div>
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-6">
              <h2 className="text-xl font-semibold">Orders</h2>
              <p className="mt-2 text-slate-600">Review your existing orders and status.</p>
            </div>
          </div>
        </section>
      </main>
